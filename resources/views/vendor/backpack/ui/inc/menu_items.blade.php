...
<x-backpack::menu-item title="Documentos" icon="la la-book" :link="backpack_url('documento')" />
<x-backpack::menu-item title="Copias" icon="la la-copy" :link="backpack_url('copia')" />

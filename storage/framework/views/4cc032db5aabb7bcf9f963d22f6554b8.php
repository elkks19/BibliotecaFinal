 ...
 ?>
  ...
  <?php Basset::basset('https://cdn.datatables.net/1.13.1/js/jquery.dataTables.min.js'); ?>
  <?php Basset::basset('https://cdn.datatables.net/1.13.1/js/dataTables.bootstrap5.min.js'); ?>
  <?php Basset::basset('https://cdn.datatables.net/responsive/2.4.0/js/dataTables.responsive.min.js'); ?>
  <?php Basset::basset('https://cdn.datatables.net/responsive/2.4.0/css/responsive.dataTables.min.css'); ?>
  <?php Basset::basset('https://cdn.datatables.net/fixedheader/3.3.1/js/dataTables.fixedHeader.min.js'); ?>
  <?php Basset::basset('https://cdn.datatables.net/fixedheader/3.3.1/css/fixedHeader.dataTables.min.css'); ?>

  <?php Basset::basset(base_path('vendor/backpack/crud/src/resources/assets/img/spinner.svg'), false); ?>
      ...
      dataTableConfiguration: {
        ...
        */
        ...
        language: {
              ...
              "processing":     "<img src='<?php echo e(Basset::getUrl('vendor/backpack/crud/src/resources/assets/img/spinner.svg')); ?>' alt='<?php echo e(trans('backpack::crud.processing')); ?>'>",
              "search": "_INPUT_",
  ...
  <script type="text/javascript">
    jQuery(document).ready(function($) {
      ...
      <?php if($crud->getOperationSetting('resetButton') ?? true): ?>
        ...
        var crudTableResetButton = '<a href="<?php echo e(url($crud->route)); ?>" class="ml-1 ms-1" id="crudTable_reset_button"><?php echo e(trans('backpack::crud.reset')); ?></a>';
...
<?php /**PATH /home/elkks19/Documentos/Unifranz/Semestre 5/PROYECTO_FINAL/bibliotecaFINAL/vendor/backpack/crud/src/resources/views/crud/inc/datatables_logic.blade.php ENDPATH**/ ?>
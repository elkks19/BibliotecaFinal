<?php if($crud->hasAccess('update', $entry)): ?>
	<?php if(!$crud->model->translationEnabled()): ?>

	
	<a href="<?php echo e(url($crud->route.'/'.$entry->getKey().'/edit')); ?>" class="btn btn-sm btn-link">
	...
	<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/elkks19/Documentos/Unifranz/Semestre 5/PROYECTO_FINAL/bibliotecaFINAL/vendor/backpack/crud/src/resources/views/crud/buttons/update.blade.php ENDPATH**/ ?>
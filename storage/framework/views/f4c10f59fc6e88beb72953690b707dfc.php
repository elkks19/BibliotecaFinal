<?php if($crud->exportButtons()): ?>
  <?php Basset::basset('https://cdn.datatables.net/buttons/2.3.3/css/buttons.bootstrap5.min.css'); ?>
  <?php Basset::basset('https://cdn.datatables.net/buttons/2.3.3/js/dataTables.buttons.min.js'); ?>
  <?php Basset::basset('https://cdn.datatables.net/buttons/2.3.3/js/buttons.bootstrap5.min.js'); ?>
  <?php Basset::basset('https://cdnjs.cloudflare.com/ajax/libs/jszip/2.5.0/jszip.min.js'); ?>
  <?php Basset::basset('https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.18/pdfmake.min.js'); ?>
  <?php Basset::basset('https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.18/vfs_fonts.js'); ?>
  <?php Basset::basset('https://cdn.datatables.net/buttons/2.3.2/js/buttons.html5.min.js'); ?>
  <?php Basset::basset('https://cdn.datatables.net/buttons/2.3.2/js/buttons.print.min.js'); ?>
  <?php Basset::basset('https://cdn.datatables.net/buttons/2.3.2/js/buttons.colVis.min.js'); ?>
  <script>
...
<?php endif; ?>
<?php /**PATH /home/elkks19/Documentos/Unifranz/Semestre 5/PROYECTO_FINAL/bibliotecaFINAL/vendor/backpack/crud/src/resources/views/crud/inc/export_buttons.blade.php ENDPATH**/ ?>
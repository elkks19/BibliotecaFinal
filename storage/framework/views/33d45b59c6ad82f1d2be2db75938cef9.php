...
<?php echo $__env->make('crud::fields.inc.wrapper_start', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="existing-file">
    	...
    	<a href="#" class="file_clear_button btn btn-light btn-sm float-right" title="Clear file" data-filename="<?php echo e($field['value']); ?>"><i class="la la-remove"></i></a>
    ...
    <div class="backstrap-file <?php echo e(isset($field['value']) && $field['value']!=null?'d-none':''); ?>">
        <input
            ...
            data-filename="<?php echo e($field['value'] ?? ''); ?>"
            <?php echo $__env->make('crud::fields.inc.attributes', ['default_class' => 'file_input backstrap-file-input'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        >
...
<?php $__env->startPush('crud_fields_styles'); ?>
  <?php $bassetBlock = 'backpack/crud/fields/upload-field.css'; ob_start(); ?>
    <style type="text/css">
        .existing-file {
...
<?php $__env->startPush('crud_fields_scripts'); ?>
  <?php $bassetBlock = 'backpack/crud/fields/upload-field.js'; ob_start(); ?>
    <script>
  ...
  <?php Basset::bassetBlock($bassetBlock, ob_get_clean()); ?>
<?php $__env->stopPush(); ?>
<?php /**PATH /home/elkks19/Documentos/Unifranz/Semestre 5/PROYECTO_FINAL/bibliotecaFINAL/vendor/backpack/crud/src/resources/views/crud/fields/upload.blade.php ENDPATH**/ ?>
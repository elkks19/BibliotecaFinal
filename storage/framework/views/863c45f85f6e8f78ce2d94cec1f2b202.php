...
<body>
    ...
    <div class="d-flex justify-content-between w-full">
        ...
        <a class="btn btn-primary" href="<?php echo e(route('reportes.prestamosPorFecha.pdf')); ?>">
            Descargar reporte
        </a>
    </div>
    <?php endif; ?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($prestamo->fechaDevolucion->format('d-m-Y')); ?></td>
...
<?php /**PATH /media/data/Unifranz/Semestre 5/PROYECTO FINAL/PROYECTO/resources/views/reportes/prestamosPorFecha.blade.php ENDPATH**/ ?>
<?php if($crud->hasAccess('delete', $entry)): ?>
    <a href="javascript:void(0)" onclick="deleteEntry(this)" data-route="<?php echo e(url($crud->route.'/'.$entry->getKey())); ?>" class="btn btn-sm btn-link" data-button-type="delete">
        <span><i class="la la-trash"></i> <?php echo e(trans('backpack::crud.delete')); ?></span>
    </a>
<?php endif; ?>
...
<?php /**PATH /home/elkks19/Documentos/Unifranz/Semestre 5/PROYECTO_FINAL/bibliotecaFINAL/vendor/backpack/crud/src/resources/views/crud/buttons/delete.blade.php ENDPATH**/ ?>